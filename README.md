...
3. Results are evaluated and displayed.
...
3. Add environment variables: MongoDB, Redis, JWT, Judge0 and Gemini API keys
...
# MongoDB, Redis, JWT, Judge0 and Gemini API keys
